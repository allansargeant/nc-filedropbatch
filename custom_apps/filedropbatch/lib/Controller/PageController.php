...
class PageController extends Controller {
    ...
    public function index(): TemplateResponse {
        ...
        // The About dialog. Both files are vendored from
        // stoatworks-backend/about and generated by its sync-about.py - edit
        // them there and re-run the sync, never here. about-data.js only sets
        // defaults, so the load order between the two does not matter.
        Util::addScript(Application::APP_ID, 'about-data');
